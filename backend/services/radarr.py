...
class RadarrClient:
    ...
    def create_tag(self, label: str) -> RadarrTag:
        """Create a new tag.
        ...
        return RadarrTag(id=data["id"], label=data["label"])

    def get_or_create_tag(self, label: str) -> RadarrTag:
    ...
    def search_movie(self, tmdb_id: int) -> RadarrMovie:
    ...
    def add_tag_to_movies(self, movie_ids: list[int], tag_id: int) -> list[RadarrMovie]:
