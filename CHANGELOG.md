...
- The Docker image now installs the exact dependency versions from `uv.lock`, so new upstream releases can't break a build.

## [0.5.2] - 2026-09-25

### Fixed

- Services can now be saved when set to disabled without an API key.
