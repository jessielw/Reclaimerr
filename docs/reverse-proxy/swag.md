...
3. Ensure your SWAG default site config includes the method you use:
   ...
   - `include /config/nginx/proxy-confs/*.subfolder.conf;` (not used in this doc)
...
- `/config/nginx/site-confs/reclaimerr-root.conf`
...
- Subdomain proxying is generally more reliable than subfolder proxying.
